...
con=sqlcon.connect(host="localhost",user="root",password="lahmiksJ2@")#connection to mysql 
cur=con.cursor()
...
root=Tk()
label=Label(root,text="SAI SPECIALITY HOSPITAL",font="arial 40 bold",bg='light pink')
b1=Button(text="Registration",font="arial 20 bold",bg='blue',command=register)
b2=Button(text="Appointment",font="arial 20 bold",bg='blue',command=apoint)
b3=Button(text="List of Doctors",font="arial 20 bold",bg='blue',command=lst_doc)
